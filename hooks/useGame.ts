    ...
    const gameLoop = async () => {
      try {
          ...
          if (!newQuest) {
              ...
              if (queued) {
                  newQuest = queued;
                  managedHero.queuedQuest = null; // 出列
